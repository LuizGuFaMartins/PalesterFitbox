...
public class JanCadTreinador extends javax.swing.JFrame {

    private static JanCadTreinador janCadTrei;
    private Treinador treinador = new Treinador();
    
    public JanCadTreinador() {
        initComponents();
        setExtendedState(MAXIMIZED_BOTH);
    }

    public static JanCadTreinador getJanCadTrei(){
        if(janCadTrei == null){
            janCadTrei = new JanCadTreinador();
        }
        return janCadTrei;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cadastro de treinadores");
    ...
    private void mnuCadAlActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuCadAlActionPerformed
        ...
        JanCadTreinador.getJanCadTrei().setVisible(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            treinador.setCref(TextCref.getText());            
            BdTreinador.cadastrar(treinador);
